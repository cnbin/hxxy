...
-(void)setTitle:(NSString *)title
{
  ...
  //  CGSize titleSize = [title boundingRectWithSize:titleLabel.font constrainedToSize:CGSizeMake(navigationBack.frame.size.width, CGFLOAT_MAX) lineBreakMode:NSLineBreakByClipping];
